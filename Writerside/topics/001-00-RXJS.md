...
concise "Requête A" as RA
concise "Requête B" as RB

S -> R : switchMap(v => http(v))
...
concise "Requête A" as RA
concise "Requête C" as RC

S -> R : exhaustMap(v => http(v))
