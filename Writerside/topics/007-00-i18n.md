...
TPL --down-> "1. Marquer les textes\n(attribut i18n)"

"1. Marquer les textes\n(attribut i18n)" --> "2. Extraire les textes\n(ng extract-i18n)"
"2. Extraire les textes\n(ng extract-i18n)" --> file "messages.xlf" as XLF_SRC #LightGray
}

package "Traducteur" {
XLF_SRC --right--> "3. Traduire le fichier"
"3. Traduire le fichier" --down--> file "messages.fr.xlf" as XLF_FR #LightBlue
}

package "Build" {
TPL -right-> "4. Compiler l'application" as Build
XLF_FR -up-> Build
Build --down-> file "Appli en Français" as AppFR #LightBlue
}
